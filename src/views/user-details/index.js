...
const DetailUser = ({ history }) => {
  ...
  const notifySuccessUpdate = () => toast.success(<SuccessUpdate />, { hideProgressBar: true })
          ...
          {readonlyInput ? (
            <Row>
              <Col xs='12' className='d-flex justify-content-end'>
                <Button color='primary' style={{marginLeft: '0.2rem', marginRight: '0.2rem'}} onClick={() => setReadonlyInput(false)} outline>Update Data</Button>
              </Col>
            </Row>
          ) : (
            <Row>
              <Col xs='12' className='d-flex justify-content-end'>
                <Button color='danger' style={{marginLeft: '0.2rem', marginRight: '0.2rem'}} onClick={() => setReadonlyInput(true)} >Cancel</Button>
                <Button color='primary' style={{marginLeft: '0.2rem', marginRight: '0.2rem'}} onClick={updateUser} >Update</Button>
              </Col>
            </Row>
          )}
